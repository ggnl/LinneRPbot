...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("LinneRP Server Status", "https://cdn.discordapp.com/attachments/865599018985848893/865605293730562068/rsz_1linnerplogo1.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ LinneRP' : '⚫ LinneRP')
    .setTimestamp(new Date())
    .addField('\n\u200b\nHoe kan je de server joinen?','Je kan de server joinen doormiddel van **Linne Roleplay** in te voeren bij het zoeken of zie de url https://cfx.re/join/kg83aa. Onderaan staat de server status om te kijken hoeveel mensen er online zijn en in de wachtrij staan. Bekijk eerst de onderstaande channels voor meer informatie voordat je een ticket aanmaakt.,, \n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  bot.on('ready',() => {
    ...
    // bot.user.setGame('Roofstad', 'https://www.youtube.com/galinogamesnl');
    bot.user.setActivity('LinneRP',{'url':'https://www.youtube.com/galinogamesnl','type':'STREAMING'});
